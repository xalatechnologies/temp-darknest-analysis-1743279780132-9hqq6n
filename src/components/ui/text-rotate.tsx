...
// Add this to fix the Intl.Segmenter type error
declare global {
  interface Intl {
    Segmenter?: {
...
export interface TextRotateRef {
  next: () => void
  previous: () => void
  jumpTo: (index: number) => void // Modified to accept an index parameter
  reset: () => void
}
...
const TextRotate = forwardRef<TextRotateRef, TextRotateProps>(
  (
    ...
    // Fix the jumpTo function to accept a parameter
